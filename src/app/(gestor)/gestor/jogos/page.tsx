...
import { useJogosGestor } from '@/hooks/core/useJogosGestor';
...
export default function GestorJogosPage() {
  const [filtroModalidade, setFiltroModalidade] = useState('todas');
  const [busca, setBusca] = useState('');
  const debouncedBusca = useDebounce(busca, 300);

  const { jogos, stats, isLoading } = useJogosGestor(filtroModalidade, debouncedBusca);
      ...
      <div className="container-custom page-padding space-y-8">
        <div>
          ...
          <p className="body-medium text-muted-foreground">
            Histórico completo de todos os jogos realizados na arena
          </p>
        </div>
    ...
    <div className="container-custom page-padding space-y-8">
      ...
      <div className="space-y-4">
        {jogos.map((jogo: any) => {
          ...
          const totalParticipantes = jogo.participantes_count || 0;
                  ...
                  <div className="space-y-3 flex-1">
                    ...
                    <div className="flex items-center gap-4 flex-wrap">
                      <Badge variant="outline" className="bg-purple-50 text-purple-700 border-purple-200">
                        ...
                        {jogo.organizador?.nome_completo}
                      </Badge>
          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">
                {stats?.totalJogos === 0
                  ? 'Ainda não há jogos realizados no sistema.'
